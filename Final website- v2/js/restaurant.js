...
var query = firebase.database().ref("Restaurant").orderByKey();
query.once("value")
  .then(function(snapshot) {
    snapshot.forEach(function(childSnapshot) {
      ...
      var storePic = childData.image;
        ...
        a.setAttribute("href", "restorant-" + storeID + ".html");
        ...
        p.innerHTML = storeName + " restorantını görüntülemek için tıklayınız.....";
...
/*
        ...
        div.appendChild(h1);
        div.appendChild(p);
        div.style.backgroundImage = "url(" + storePic + ")";
        a.appendChild(div);
